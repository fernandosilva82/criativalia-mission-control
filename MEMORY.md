...
- **SHOPIFY_STORE:** m-s-negocios-2
- **Status:** ✅ Token disponível localmente
- **Nota:** Dados mockados foram REMOVIDOS - sistema usa dados reais

### Configuração Necessária no Render
O token precisa ser adicionado manualmente no dashboard do Render como `SHOPIFY_ACCESS_TOKEN`
